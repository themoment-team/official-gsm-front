...
const 게시중단요청신청방법 = [
  ...
  <>
    ...
    다운로드 하여 작성한 후 ‘저작권 신고 접수 수령인’에게 방문 또는 전자우편으로
    신청합니다.
  </>,
  <>
...
const 재게시요청신청방법 = [
  <>
    게시가 중단된 저작물을 게시한 이용자가 해당 저작물이 정당한 권리에 의한
    게시라고 판단되면 해당 절차에 따라서 재게시를 요청합니다.
  </>,
  <>
    게시중단을 통보받은 저작물에 대하여 재 게시를 요청할 경우에는 아래 문서를
    다운로드 하여 작성한 후 ‘저작권 신고 접수 수령인’에게 방문 또는 전자우편으로
    접수합니다.
  </>,
  <>
  ...
  <>
    ...
    수령인이 접수하여 검토 후 YES인 경우는 서비스를 제공하고 NO인 경우는 재게시
    불가 통보를한다.
  </>,
