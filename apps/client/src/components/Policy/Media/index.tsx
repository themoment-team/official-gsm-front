...
const 영상정보처리방침변경에관한사항 = [
  `이 영상정보처리기기 운영․관리방침은 2019년 11월 22일에 제정되었으며 법령ㆍ정책 또는 보안기술의변경에 따라 내용의 추가ㆍ삭제 및 수정이 있을 시에는\n본 기관 홈페이지를 통해 변경사유 및 내용 등을 공지하도록 하겠습니다.\n공고일자 : 2019년 12월 2일 / 시행일자 : 2019년 12월 2일`,
  `2012. 3. 26. ~ 2019. 12. 1. 영상정보처리기기 운영·관리방침 보기\n2019. 12. 2. ~ 현재`,
];
