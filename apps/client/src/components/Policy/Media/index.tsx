...
const 영상정보처리방침변경에관한사항 = [
  '이 영상정보처리기기 운영․관리방침은 2019년 11월 22일에 제정되었으며 법령ㆍ정책 또는 보안기술의 변경에 따라 내용의 추가ㆍ삭제 및 수정이 있을 시에는 본 기관 홈페이지를 통해 변경사유 및 내용 등을 공지하도록 하겠습니다. 공고일자 : 2019년 12월 2일 / 시행일자 : 2019년 12월 2일',
  '2012. 3. 26. ~ 2019. 12. 1. 영상정보처리기기 운영·관리방침 보기2019. 12. 2. ~ 현재',
];
    ...
    <S.Section>
      ...
      <S.SubContentWrapper>
        ...
        <S.Description>
          ...
          영상정보처리기기 운영․관리 방침을 통해 본 기관에서 처리하는 영상정보가
          어떠한 용도와 방식으로 이용ㆍ관리되고 있는지 알려드립니다.
        </S.Description>
      </S.SubContentWrapper>
      <S.SubContentWrapper>
        <S.BoldSubTitle>
